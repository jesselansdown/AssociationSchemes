...
Print(P);
#! [ [ 1, 18, 18, 18, 72, 72, 72, 9 ], [ 1, 4, 4, 4, 16, -12, -12, -5 ], [ 1, -2, -2, 10, -8, 0, 0, 1 ], [ 1, -2, 10, -2, -8, 0, 0, 1 ], 
#!  [ 1, 10, -2, -2, -8, 0, 0, 1 ], [ 1, -2, -2, -2, 0, -8*E(7)^3-8*E(7)^5-8*E(7)^6, -8*E(7)-8*E(7)^2-8*E(7)^4, -3 ], 
#!  [ 1, -2, -2, -2, 0, -8*E(7)-8*E(7)^2-8*E(7)^4, -8*E(7)^3-8*E(7)^5-8*E(7)^6, -3 ], [ 1, -2, -2, -2, 7, -3, -3, 4 ] ]
#! @EndExample
...
fusions := List(Combinations(valency18,2), t -> 
		FusionScheme(A, [[0], t, Difference([1..7],t)]) );
#! @EndExample
